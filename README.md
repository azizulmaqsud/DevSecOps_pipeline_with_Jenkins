...
- Clone your application's code repository onto the EC2 instance:
    ...
    ```bash
    git clone https://github.com/azizulmaqsud/DevSecOps_pipeline_with_Jenkins.git
    ```
...
It will show an error because it needs API key
...
Successfully installed the Dependency-Check plugin, tool is configured, and added Docker-related plugins along with your DockerHub credentials in Jenkins. Now proceed with configuring Jenkins pipeline to include the following tools and credentials in the CI/CD process.
